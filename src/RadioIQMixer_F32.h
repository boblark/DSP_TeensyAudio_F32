 ...
 * 
 * Time:  For an update of a 128 sample block, doSimple=1, 46 microseconds
 */
 
#ifndef _radioIQMixer_f32_h
#define _radioIQMixer_f32_h

// Does timing tests, temporary, maybe to do T4.0 test
#define TEST_TIME_IQM 0
...
#if TEST_TIME_IQM
//  *Temporary* - TEST_TIME_IQM allows measuring time in microseconds for each part of the update()
